...
<body>
    ...
    <div class="mb-4 text-center">
        ...
        <h1 class="h4 mb-0 font-weight-light">My<b>POS</b></h1>
        <p class="small text-muted">Silahkan Login Disini</p>
    </div>
    ...
    <p class="mt-3 mb-3 text-muted text-center">&copy; <?= date('Y') ?> Fershoft</p>
    <?= form_close(); ?>
